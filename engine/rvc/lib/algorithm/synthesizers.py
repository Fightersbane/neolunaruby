# Vendored from ultimate_rvc.rvc.lib.algorithm.synthesizers, trimmed for
# neolunamiku: the RefineGAN generator was removed (its torchaudio dependency
# is not worth carrying — RVC v2 voice models use the HiFi-GAN family).
...
from engine.rvc.lib.algorithm.commons import rand_slice_segments, slice_segments
from engine.rvc.lib.algorithm.encoders import PosteriorEncoder, TextEncoder
from engine.rvc.lib.algorithm.generators.hifigan import HiFiGANGenerator
from engine.rvc.lib.algorithm.generators.hifigan_mrf import HiFiGANMRFGenerator
from engine.rvc.lib.algorithm.generators.hifigan_nsf import HiFiGANNSFGenerator
from engine.rvc.lib.algorithm.residuals import ResidualCouplingBlock
        ...
        **kwargs,
        ...
        if use_f0:
            if vocoder == "MRF HiFi-GAN":
                ...
                msg = (
                    "RefineGAN vocoder was removed from the slim build "
